...
public class MainTS_S_Limit extends  MyRandom {
	public MainTS_S_Limit() {}
...
//	double percenttTest=0;
	...
	String outDir = OUTDIR + "TS_S_Limit/";
	public void MStart()
	{
...
//		f3.close();		
	...
	{
		MainTS_S_Limit a = new MainTS_S_Limit();	
		
	
		
		System.out.printf("Main TS_S with Limit Start: "+ PROBLEM + "\n");
		a.MStart();
