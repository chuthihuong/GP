...
public class MainTS_S extends  MyRandom {
	public MainTS_S() {}
...
//			f1.println(myPop.timeTournament[0]);
...
//				f1.println(myPop.timeTournament[i]);
...
//			}
			...
			f2.println(myPop.bestcurrent[pos].fitness + " " + fittest 
					+ " " + myPop.bestcurrent[pos].size + " " + starttime + " "+myPop.timeTournament+ "\n");
